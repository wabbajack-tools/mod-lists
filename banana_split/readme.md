...
4. Download the newest BananaSplit v2.8.2.wabbajack file from the Wabbajack Discord, or install directly from the Wabbajack User Interface.
...
8. Navigate to the BananaSplit v2.8.2.wabbajack file you just downloaded.

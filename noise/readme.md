...
If you don’t see _Installation complete_, Wabbajack has probably encountered an error and must be restarted. To help make sure that an error does not happen again, please refer to the Setting Up Your System section and delete the listed folders again. Inside of the NOISE folder, delete everything except the downloads folder or Wabbajack.exe and the modlist file.

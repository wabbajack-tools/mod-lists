...
```
Xunit.Sdk.FailException: Unable to Validate "https://raw.githubusercontent.com/Drheisen1/Authoria-Requiem-Reforged/main/modlists.json". Due to the following Error:
Xunit.Sdk.TrueException: MachineUrl/ModlistRepository is not valid! Allowed Characters are: 0-9, A-Z, a-z, _ and - use https://regex101.com/r/cVYtyA/2to test: "" ("Authoria - Requiem Reforged")

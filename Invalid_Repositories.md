...
```
Xunit.Sdk.FailException: Unable to Validate "https://raw.githubusercontent.com/lukxsofficial/modlists/main/modlists.json". Due to the following Error:
Xunit.Sdk.TrueException: Modlist has no valid Readme Url (Unable to create Uri)! ("Skyrim Essentials Framework")
